...
<aside class="Hui-aside">
	...
	<div class="menu_dropdown bk_2" style="display:none">
		<dl id="menu-aaaaa">
			...
			<dd>
				<ul>
					<li><a data-href="article-list.jsp" data-title="资讯管理" href="javascript:void(0)">三级导航</a></li>
				</ul>
			</dd>
		</dl>
	</div>
...
<!--_footer 作为公共模版分离出去-->
<script type="text/javascript" src="lib/jquery/1.9.1/jquery.mext/javascript" src="static/h-ui.admin/js/H-ui.admin.js"></script> <!--/_footer 作为公共模版分离出去-->
