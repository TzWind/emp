  ...
  <div class="article-class-list cl mt-20">
    <table class="table table-border table-bordered table-hover table-bg">
      ...
      <tbody>
        ...
        <tr class="text-c">
          <td><input type="checkbox" name="" value=""></td>
          e_class_edit('3','620','160','分类编辑','article-class-edit.jsp')" style="text-decoration:none"><i class="icon-edit"></i></a> <a title="删除" href="javascript:;" onclick="article_class_del(this,'3')" class="ml-5" style="text-decoration:none"><i class="icon-trash"></i></a></td>
        </tr>
      </tbody>
    </table>
  </div>
